...
namespace Rapid
{
	...
	public partial class FormClientDocOrder : Form
	{
		...
		public MsSQLShort OrderMySQL = new MsSQLShort();
		public MsSQLFull OrderTS_MySQL = new MsSQLFull();
		...
		void LoadTabularSection()
		{
			// Формируем табличную часть
				...
				OrderTS_MySQL.InsertParametersAdd("@tabularSection_price", SqlDbType.Float, 10, "tabularSection_price", UpdateRowSource.None);
				OrderTS_MySQL.InsertParametersAdd("@tabularSection_NDS", SqlDbType.Float, 10, "tabularSection_NDS", UpdateRowSource.None);
				OrderTS_MySQL.InsertParametersAdd("@tabularSection_sum", SqlDbType.Float, 10, "tabularSection_sum", UpdateRowSource.None);
				OrderTS_MySQL.InsertParametersAdd("@tabularSection_total", SqlDbType.Float, 10, "tabularSection_total", UpdateRowSource.None);
				OrderTS_MySQL.InsertParametersAdd("@tabularSection_id_doc", SqlDbType.VarChar, 250, "tabularSection_id_doc", UpdateRowSource.None);
				...
				OrderTS_MySQL.UpdateParametersAdd("@tabularSection_tmc", SqlDbType.VarChar, 250, "tabularSection_tmc", UpdateRowSource.None);
				OrderTS_MySQL.UpdateParametersAdd("@tabularSection_units", SqlDbType.VarChar, 250, "tabularSection_units", UpdateRowSource.None);
				OrderTS_MySQL.UpdateParametersAdd("@tabularSection_number", SqlDbType.Float, 10, "tabularSection_number", UpdateRowSource.None);
				OrderTS_MySQL.UpdateParametersAdd("@tabularSection_price", SqlDbType.Float, 10, "tabularSection_price", UpdateRowSource.None);
				OrderTS_MySQL.UpdateParametersAdd("@tabularSection_NDS", SqlDbType.Float, 10, "tabularSection_NDS", UpdateRowSource.None);
				OrderTS_MySQL.UpdateParametersAdd("@tabularSection_sum", SqlDbType.Float, 10, "tabularSection_sum", UpdateRowSource.None);
				OrderTS_MySQL.UpdateParametersAdd("@tabularSection_total", SqlDbType.Float, 10, "tabularSection_total", UpdateRowSource.None);
				OrderTS_MySQL.UpdateParametersAdd("@tabularSection_id_doc", SqlDbType.VarChar, 250, "tabularSection_id_doc", UpdateRowSource.None);
				OrderTS_MySQL.UpdateParametersAdd("@id_tabularSection", SqlDbType.SmallInt, 11, "id_tabularSection", UpdateRowSource.None);
				
				OrderTS_MySQL.DeleteSqlCommand = "DELETE FROM tabularsection WHERE (id_tabularSection = @id_tabularSection)";
				OrderTS_MySQL.DeleteParametersAdd("@id_tabularSection", SqlDbType.SmallInt, 11, "id_tabularSection", UpdateRowSource.None);
