...
namespace Rapid
{
	partial class FormClientJournalOrder
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormClientJournalOrder));
			...
			this.заказToolStripMenuItem.Size = new System.Drawing.Size(186, 22);
			this.заказToolStripMenuItem.Text = "Создать Заказ";
			...
			this.изменитьДокументToolStripMenuItem.Size = new System.Drawing.Size(186, 22);
			...
			this.удалитьДокументToolStripMenuItem.Size = new System.Drawing.Size(186, 22);
			...
			this.Name = "FormClientJournalOrder";
			this.Text = "Журнал: Заказов";
			this.Closed += new System.EventHandler(this.FormClientJournalOrderClosed);
			this.Load += new System.EventHandler(this.FormClientJournalOrderLoad);
