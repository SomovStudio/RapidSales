...
namespace Rapid
{
	partial class FormClientReportBuyer
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormClientReportBuyer));
			...
			this.label2.Text = "Отчёт: Оборотная ведомость по покупателю.";
			// 
			// dateTimePicker2
			// 
			...
			this.Name = "FormClientReportBuyer";
			this.Text = "Оборотная ведомость по покупателю";
			this.Load += new System.EventHandler(this.FormClientReportBuyerLoad);
