...
namespace Rapid
{
	partial class FormClientReportSupplier
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormClientReportSupplier));
			...
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(370, 59);
			...
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(88, 61);
			...
			this.label2.Text = "Отчёт: Оборотная ведомость по поставщику.";
			// 
			// dateTimePicker2
			// 
			...
			this.Name = "FormClientReportSupplier";
			this.Text = "Оборотная ведомость по поставщику";
			this.Load += new System.EventHandler(this.FormClientReportSupplierLoad);
